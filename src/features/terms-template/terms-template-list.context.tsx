...
import { TermTemplate } from "./terms-template-form.context";

export type TermTemplateListItem = Pick<TermTemplate, 'id' | 'name' | "createdAt" | "updatedAt">;
//define the state's form
export interface TermTemplateListState {
    items: TermTemplateListItem[] | null
}
...
type Add = { type: 'add'; payload: TermTemplateListItem };
type Set = { type: 'set'; payload: TermTemplateListItem[] };
